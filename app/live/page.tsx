    ...
    <div className="min-h-screen bg-paper text-ink">
      ...
      <main className="mx-auto max-w-5xl px-5 py-16">
        ...
        <p className="mt-5 max-w-3xl text-ink/70">
          Samsara and Motive are not public. Anyone can read the FMCSA company census and SMS violation files. The
          server pulls those, stores the carrier in SQLite, maps each roadside defect, and runs the same agent.
        </p>
